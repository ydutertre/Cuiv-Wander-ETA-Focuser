...
; Generated by Cuiv on 7/28/2025 (UTC)
;
[Setup]
AppID={{1129d044-34b4-46c1-bfe0-efc46a029018}
AppName=ASCOM Cuiv WandererETA Focuser Driver
AppVerName=ASCOM Cuiv WandererETA Focuser Driver 0.1
AppVersion=0.1
AppPublisher=Cuiv <cuivlazygeek@gmail.com>
AppPublisherURL=mailto:cuivlazygeek@gmail.com
...
OutputDir="."
OutputBaseFilename="Cuiv WandererETA Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Focuser\Cuiv WandererETA"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Focuser\Cuiv WandererETA"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "C:\Users\yanni\source\repos\Cuiv Wander ETA Focuser\Cuiv Wander ETA Focuser\ASCOM.CuivWandererETA.exe"; DestDir: "{app}" ;AfterInstall: RegASCOM()
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "C:\Users\yanni\source\repos\Cuiv Wander ETA Focuser\Cuiv Wander ETA Focuser\Readme.txt"; DestDir: "{app}"; Flags: isreadme
; TODO: Add other files needed by your driver here (add subfolders above)

;Only if COM Local Server
[Run]
Filename: "{app}\ASCOM.CuivWandererETA.exe"; Parameters: "/regserver"
...
;Only if COM Local Server
[UninstallRun]
Filename: "{app}\ASCOM.CuivWandererETA.exe"; Parameters: "/unregserver"
...
Root: HKCR; Subkey: AppId\{#AppClsid}; ValueType: string; ValueData: "ASCOM Cuiv WandererETA Focuser Driver"
...
Root: HKCR; Subkey: AppId\ASCOM.CuivWandererETA.exe; ValueType: string; ValueName: AppID; ValueData: {#AppClsid}
; CAUTION! DO NOT EDIT - DELETING ENTIRE APPID TREE WILL BREAK WINDOWS!
Root: HKCR; Subkey: AppId\{#AppClsid}; Flags: uninsdeletekey
Root: HKCR; Subkey: AppId\ASCOM.CuivWandererETA.exe; Flags: uninsdeletekey
...
begin
   ...
   P.Register('Cuiv WandererETA.Focuser', 'Cuiv WandererETA');
end;
...
begin
   ...
   begin
     P := CreateOleObject('ASCOM.Utilities.Profile');
     P.DeviceType := 'Focuser';
     P.Unregister('Cuiv WandererETA.Focuser');
  end;
end;
